...
async function sendMessage() {
    ...
    // System prompt to make AI remember its name and personality
    const systemMessage = `
...
`;
    ...
    try {
        ...
        if (!response.ok) {
            ...
            displayMessage("Ans: API Error 😔 Check console for details", "bot");
            return;
        }
        ...
        displayMessage("Ans: Something went wrong 😔", "bot");
    }
}
